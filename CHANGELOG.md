...
- Bumped development dependencies: `phpunit/phpunit` to `13.2.4` and `friendsofphp/php-cs-fixer` to `3.95.15`.
- Bumped GitHub Actions: `actions/labeler` to `7.0.0`, `github/codeql-action/upload-sarif` to `4.37.2`, and `softprops/action-gh-release` to `3.0.2`.
