...
final class PandaApi extends AbstractApiService
{
    /**
    ...
    {
        return $this->call('flickr.panda.getList', $parameters, $options);
    }
    ...
    {
        return $this->call('flickr.panda.getPhotos', $parameters, $options);
    }
}
